...
function pug_rethrow(err, filename, lineno, str){
  ...
  try {
    str = str || __webpack_require__(168).readFileSync(filename, 'utf8')
  } catch (ex) {
...
var _auth = __webpack_require__(165);
...
var Hello = exports.Hello = function (_React$Component) {
    ...
    _createClass(Hello, [{
        ...
        value: function create(node) {
            _reactDom2.default.render(_react2.default.createElement(Hello, null), node);
        }
    }]);
...
var _auth = __webpack_require__(87);
...
var _test = __webpack_require__(89);

window.addEventListener('DOMContentLoaded', function () {
    _test.Hello.create(document.querySelector('.js-hello'));
...
var pug = __webpack_require__(51);
